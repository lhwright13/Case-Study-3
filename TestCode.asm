...
init
	...
	movwf	TRISC	;Configure Port C as all inputs
					;Port C pin 7green button
					;Port C pin 6red button
	movlw   B'00001010'
	movwf   ADCON1
	movlw	B'00000111'				
...
GreenPress
	...
	btfss	PORTC,7	;See if green button still Pressed
	goto waitPress
	
GreenRelease

	btfsc PORTC,7	;See if green button released
	goto GreenRelease
...
RedPress1
	btfss PORTC,6	;See if red button still Pressed(avoid noise)
	goto waitPress1
	
RedRelease1

	btfsc PORTC,6	;See if red button is released
...
RedPress2
	btfss PORTC,6	;See if red button still Pressed
	goto waitPress2
...
;check whether red button is pressed again.
	btfsc PORTC,6	;See if red button Pressed
...
Active
	btfss PORTC,6	;if red button isn't pressed, bagin the main part if Active	
	goto ActiveBegin
